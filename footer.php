  ...
  <section class="container footer">
    <div class="row row--align-items-top">
      <div class="col-4 sm-col-10 sm-col-centered">
        ...
        <p>Paragraph Sample. Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor. Donec ullamcorper nulla non metus auctor fringilla. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Duis mollis, est non commodo luctus.</p>
      </div>
      <div class="col-2 text-left sm-col-10 sm-col-centered footer-nav">
        <h3>About Us</h3>
        <hr />
